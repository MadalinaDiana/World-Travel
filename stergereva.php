...
$nume = "";
  if (empty($_POST["nume"])) {
    $nameErr = "<font color='red'>Este necesar sa introduceti un nume.</font>";
    echo $nameErr;
  } else {
    $nume = $_POST["nume"];
    $result= mysqli_query($db,"CALL stergere2('$nume')");
  }
if (!$result)
 die('Invalid querry:' .mysqli_error($db));
 else 
 {
    echo "<p align=center><font color='red'><i>Vacanta ".$nume." a fost stearsa</i></font></p>";
 }
