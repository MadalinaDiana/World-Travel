...
<!------ Include the above in your HEAD tag ---------->
 ...
 $querry="SELECT pagini.nume_meniu, pagini.pagina FROM pagini INNER JOIN drepturi ON drepturi.IdPage=pagini.Id WHERE drepturi.IdUser='$IdUser' and pagini.Meniu='1'";
