      ...
      <nav class="navbar navbar-default" role="navigation">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span
              class="glyphicon glyphicon-list-alt"></span>Conturi <b class="caret"></b></a>
...
<?php
    ...
    $phone=$_POST["mobile0"];
    $pass=$_POST["password"];
if( !empty($name0)|| !empty($mail0)||!empty($mobile0)||!empty($pass)){
$host="localhost";
$dbUsername="root";
$dbPassword="";
$dbname="worldtravel";
...
$query= "insert into login values('','$user','$encrypted_pass','$email', '$phone', 'admin')";
$query_run = mysqli_query($conn, $query);			
if($query_run){
...
?>
<?php
echo "<h2><p align=center><font color=red>Datele Introduse:</font></h2></p>";
echo "<p align=center><i>$user </i></p>";
echo "<p align=center><i>$email</i> </p>";
echo "<p align=center><i>$phone </i></p>";
echo "<br>";
?>
<div>
