...
<div align="center">
<h2><font color="blue"><b>Vizualizare Clienti</b></font></h2>
<table style="width:324px;" border="3" cellspacing="1" cellpadding="1">
<tr>
<td style="background-color:#A4A4A4;">
<b><font face="Arial, Helvetica, sans-serif">Nr</font></b>
</td>
<td style="background-color:#A4A4A4;">
<b><font face="Arial, Helvetica, sans-serif">Nume</font></b>
</td>
<td style="background-color:#A4A4A4;">
<b><font face="Arial, Helvetica, sans-serif">Email</font></b>
</td>
<td style="background-color:#A4A4A4;">
<b><font face="Arial, Helvetica, sans-serif">Phone</font></b>
</td>
</tr>
...
$sqlv="SELECT * FROM login WHERE type LIKE 'client' LIMIT $start, $limit"; 
$resultv= mysqli_query($db,$sqlv);
 ...
 else 
 {
     ...
     echo $myrow["id"];
      ...
      echo "</td></tr>"; }
  echo "</p></table>";
$rows= mysqli_num_rows(mysqli_query($db,"SELECT * FROM login WHERE type LIKE 'client' "));
