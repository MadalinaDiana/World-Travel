...
<br>
<div align="center">
<caption><h2><ins><i>Conturi Parteneri</i></ins></h2></caption>
</div>

<table style="width:65%;height:90%;" align="center">
<tr>
<th colspan="6" style="background-color:#5E1D55;color:white;"><h3>Vizualizare Parteneri</h3></th>
</tr>
<tr style="background-color:#32A9EE;color:white;">
<td><b><font face="Arial, Helvetica, sans-serif">Nr</font></b></td>
<td><b><font face="Arial, Helvetica, sans-serif">Nume</font></b></td>
<td><b><font face="Arial, Helvetica, sans-serif">Prenume</font></b></td>
<td><b><font face="Arial, Helvetica, sans-serif">Email</font></b></td>
<td><b><font face="Arial, Helvetica, sans-serif">Newpass</font></b></td>
<td><b><font face="Arial, Helvetica, sans-serif">Phone</font></b></td>
...
$sqlv="SELECT * FROM login WHERE type LIKE 'partener'  LIMIT $start, $limit"; 
$resultv= mysqli_query($db,$sqlv);
 ...
 while ($myrow=mysqli_fetch_array($resultv,MYSQLI_ASSOC))
  ...
  echo "</table>";
$rows= mysqli_num_rows(mysqli_query($db,"SELECT * FROM login WHERE type LIKE 'partener' "));
